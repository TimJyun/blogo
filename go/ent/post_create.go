...
func (pc *PostCreate) SetVersion(u uint32) *PostCreate {
...
func (pc *PostCreate) SetLastUpdate(t time.Time) *PostCreate {
...
func (pc *PostCreate) check() error {
	...
	if _, ok := pc.mutation.CreateTime(); !ok {
		return &ValidationError{Name: "createTime", err: errors.New(`ent: missing required field "Post.createTime"`)}
	}
	if _, ok := pc.mutation.LastUpdate(); !ok {
		return &ValidationError{Name: "lastUpdate", err: errors.New(`ent: missing required field "Post.lastUpdate"`)}
	}
	return nil
}
